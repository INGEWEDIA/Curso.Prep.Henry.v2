...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  var estaElemento = true;
  estaElemento = array.includes(elemento);
  if(estaElemento === true) return true;
  else return false;
}
...
function cuentoElementos(arreglo){
  ...
  elementosArray = newArray.length;
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  var empiezaConNueve = 0;
  empiezaConNueve = n.toString();
  if(empiezaConNueve[0] === '9') return true;
  else return false;
}
